public class Question {
	/*
		Chapter 5 Problem 4
		Given a positive integer, print the next smallest and the next largest numbers that have
	...
	*/
	...
	public static void main(String[] args) {
		...
		System.out.println("Previous: "+p+" (Binary: "+Integer.toBinaryString(p)+")");
		System.out.println("Next: "+n+" (Binary: "+Integer.toBinaryString(n)+")");
	}
